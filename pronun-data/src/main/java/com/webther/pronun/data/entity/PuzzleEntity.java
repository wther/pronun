...
public class PuzzleEntity {
	...
	public String toString() {
		return "PuzzleEntity [puzzleId=" + puzzleId + ", puzzleCode="
				+ puzzleCode + ", puzzleText=" + puzzleText + ", phoneticText="
				+ phoneticText + ", samplePath=" + samplePath + "]";
	}
	...
	public int hashCode() {
		...
		int result = 1;
		result = prime * result
				+ ((puzzleId == null) ? 0 : puzzleId.hashCode());
		return result;
	}
